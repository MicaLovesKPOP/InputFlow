...
namespace InputFlow.Core
{
    ...
    public class InputFlowConfig
    {
        ...
        /// Matching rules allow users to specify either a language tag or
        /// substrings of the layout or profile name.  Additional fields may
...
;
    ...
    /// BCP47 format (e.g. "en-US", "ko-KR").  LayoutNameContains and
    /// ProfileNameContains match against the layout or IME display names as
    /// reported by Windows.  These matches are case-insensitive.
    /// </summary>
